  ...
  return (
    <div className="bg-white border border-main rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 p-6 flex flex-col items-center text-center relative justify-between">
      ...
      <div className="flex flex-col items-center">
        {/* Experience Badge */}
        <span className="absolute top-3 right-3 bg-main text-white text-xs font-semibold px-3 py-1 rounded-full shadow">
          {trainer.experience}+ Yrs
        </span>

        {/* Profile Image */}
        <div className="w-28 h-28 rounded-full overflow-hidden border-4 border-main shadow-md mb-4">
          <img
            src={
      ...
      <div>
        <button
          ...
          className="mt-5 bg-main text-white hover:bg-yellow-500 rounded-xl px-5 py-2 font-semibold transition cursor-pointer"
        >
          Know More
        </button>
      </div>
